...
require_once WDS_HEADLESS_ACF_PLUGIN_DIR . 'inc/tgm/class-tgm-plugin-activation.php';
...
function register_required_plugins() {
	...
	$config = [
		'id'           => 'wds-headless-acf',          // Unique ID for hashing notices for multiple instances of TGMPA.
